...
void
WriteINIString(char* section, char* key, char* value, char* filename)
{
  FILE* fp;
...
void
GetINIString(char* section, char* key, char* def, char* dest, int destsize, char* filename)
{
  FILE* fp;
...
Sint5
GetINIInt(char* section, char* key, Sint5 def, char* filename)
{
  char buf[80];
  sprintf(buf,"%li",def);
...
void
WriteINIInt(char* section, char* key, Sint5 value, char* filename)
{
  char buf[80];
...
bool
GetINIBool(char* section, char* key, bool def, char* filename)
{
  char buf[80];
  sprintf(buf,"%i",def);
  GetINIString(section,key,buf,buf,80,filename);
...
void
WriteINIBool(char* section, char* key, bool value, char* filename)
{
