...
#if defined _VGL && !defined USE_SDL
...
#endif
#if defined USE_SDL || defined _VGL
	if (!wave_device_available)
		soundlevdoneflag=FALSE;
#endif
#if defined USE_SDL
    //SDL_Delay(1);	/* Let some CPU time go away */
#endif
#ifdef ARM
    gretrace();
    soundint();
...
#if defined _WIN32 || defined _WIN64
void
pause_windows_sound_playback(void)
{
}
void
resume_windows_sound_playback(void)
{
}
#endif
void
